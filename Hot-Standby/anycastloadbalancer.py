...
def configure_bgp(selected_server):
    ...
    if selected_server == "S1":
        ...
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"no neighbor 192.168.6.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.7.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.8.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.9.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
    elif selected_server == "S2":
        #Remove BGP prepend for R2 and add BGP prepend for R1 and R3
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.6.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"no neighbor 192.168.7.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.8.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.9.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        ...
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.7.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"no neighbor 192.168.8.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.9.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
    else:
        ...
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"neighbor 192.168.8.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
        output = subprocess.Popen("vtysh -c \"config t\" -c \"router bgp 200\" -c \"no neighbor 192.168.9.2 route-map prepend in\"", stdout=subprocess.PIPE, shell=True)
        (out, err) = output.communicate()
